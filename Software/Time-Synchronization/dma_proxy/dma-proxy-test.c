...
const char *tx_channel_names_[] = { "dma_proxy_tx", /* add unique channel names here */ };
const char *rx_channel_names_[] = { "dma_proxy_rx", /* add unique channel names here */ };
